...
public:
	...
	bool AddAttrib(LPCTSTR szAttrib, time_t szValue) { return x_SetAttrib(m_iPos, szAttrib, szValue); };
	bool AddChildAttrib( LPCTSTR szAttrib, time_t szValue ) { return x_SetAttrib(m_iPosChild,szAttrib,szValue); };
	...
	void GetDataEx(DWORD& dwData){_stscanf(GetData(),_T("%X"),&dwData);};
	
	void GetAttribEx(LPCTSTR szAttrib, time_t& tiData){ _stscanf(GetAttrib(szAttrib), _T("%lld"), &tiData); };
	void GetAttribEx(LPCTSTR szAttrib, UINT& nData){nData = (UINT)_ttoi(GetAttrib(szAttrib));};
	void GetAttribEx(LPCTSTR szAttrib, int& nData){nData = _ttoi(GetAttrib(szAttrib));};
	void GetAttribEx(LPCTSTR szAttrib, DWORD& dwData){_stscanf(GetAttrib(szAttrib),_T("%d"),&dwData);};
	...
	void GetAttribEx(LPCTSTR szAttrib, CString& strData){strData = GetAttrib(szAttrib);};
	
	void GetChildAttribEx(LPCTSTR szAttrib, time_t& tiData){_stscanf(GetAttrib(szAttrib),_T("%lld"),&tiData);};
	void GetChildAttribEx(LPCTSTR szAttrib, int& nData){nData = _ttoi(GetChildAttrib(szAttrib));};
	void GetChildAttribEx(LPCTSTR szAttrib, DWORD& dwData){_stscanf(GetAttrib(szAttrib),_T("%X"),&dwData);};
...
protected:
	...
	bool x_SetAttrib( int iPos, LPCTSTR szAttrib, time_t tiValue);
